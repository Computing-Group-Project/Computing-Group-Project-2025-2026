        ...
        <div className="max-w-7xl mx-auto px-8 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              <button onClick={toggleTheme} className="p-2 rounded-lg bg-transparent text-light-text dark:text-dark-text hover:bg-gray-100 dark:hover:bg-dark-bg transition-colors">
                {theme === 'light' ? (
