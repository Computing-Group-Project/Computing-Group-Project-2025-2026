    ...
    <div className="bg-white dark:bg-dark-card rounded-xl border border-light-border dark:border-dark-border p-8">
      <div className="mb-6">
        <div className="flex items-center gap-2 mb-2">
          <svg className={`w-6 h-6 ${theme === 'light' ? 'text-rose-400' : 'text-teal-400'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="bg-gray-50 dark:bg-dark-bg rounded-xl p-5">
          <div className="flex flex-col lg:flex-row items-stretch lg:items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <button onClick={handleTopUp} className={theme === 'light' ? 'px-5 py-2.5 rounded-lg font-medium transition-colors flex items-center gap-2 whitespace-nowrap mt-7 bg-[#F4C2C2] hover:bg-[#F0B0B0] text-gray-800' : 'px-5 py-2.5 rounded-lg font-medium transition-colors flex items-center gap-2 whitespace-nowrap mt-7 bg-[#14B8A6] hover:bg-[#0D9488] text-white'}>
                Confirm Top Up
              </button>
            </div>
          </div>
