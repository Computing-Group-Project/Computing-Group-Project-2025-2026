    ...
    <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-2xl shadow-sm p-6 h-full">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <button
          ...
          disabled={generating}
          className="px-3 py-1.5 text-sm font-medium rounded-lg bg-teal-400 text-gray-900 hover:bg-teal-500 disabled:opacity-50 transition-colors"
        >
      ...
      <div>
        {loading ? (
          <div className="text-center py-4">
            <div className="animate-spin h-6 w-6 border-2 border-teal-400 border-t-transparent rounded-full mx-auto"></div>
          </div>
