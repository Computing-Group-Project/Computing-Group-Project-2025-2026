    ...
    >
      ...
      >
        ...
        <div className="relative">
          ...
          <button
            onClick={handleClose}
            className="absolute top-4 right-4 w-10 h-10 rounded-full bg-white/80 dark:bg-slate-700 flex items-center justify-center text-gray-900 dark:text-white hover:bg-gray-200 dark:hover:bg-slate-600"
          >
            ✕
          </button>
        </div>
                ...
                {food.extras.map((extra) => {
                  ...
                  return (
                    <div
                      ...
                      ${
                        active
                          ? "border-cyan-400 bg-cyan-50 dark:bg-slate-700/50"
                          : "border-gray-200 dark:border-slate-600 bg-gray-50 dark:bg-slate-700/30 hover:border-cyan-400"
                      }`}
                    >
                      ...
                      <span className="text-gray-500 dark:text-slate-300 text-sm">
                        +GK {extra.price}
                      </span>
          ...
          <div className="mt-6 bg-gray-100 dark:bg-slate-700/40 rounded-xl p-4 flex justify-between items-center">
            ...
            <div className="flex items-center gap-4">
              ...
              <button
                ...
                className="w-10 h-10 rounded-full bg-gray-200 dark:bg-slate-700 hover:bg-gray-300 dark:hover:bg-slate-600 text-gray-900 dark:text-white flex items-center justify-center"
              >
                −
              </button>
